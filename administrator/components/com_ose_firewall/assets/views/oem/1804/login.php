					...
					<div class="bs-component">
						<div class="panel panel-primary plain">
							...
							<div class="panel-controls-buttons">
								 <button onclick="redirectTut('http://www.flexpage.dk/');" type="button" class="btn btn-sm mr5 mb10"><i class="text-primary glyphicon glyphicon-shopping-cart"></i> Subscribe To A Plan Now</button>
	                        </div>
							<div class="row mt20">
