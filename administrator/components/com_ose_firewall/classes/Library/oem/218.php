...
class CentroraOEM218 {
    ...
    public function getCalltoAction()
    {
        ...
        return '<div class="row row-set" style="margin-top:14px;">
                                <div class="col-sm-12" style="padding-left: 0px; padding-right: 20px;">
                                 <a href="https://webandwire.de/" target="_blank"><div class="call-to-action">
                                    <div class="call-to-action-txt">
                                    <img width="35" height="35" alt="C_puma" src="'.$ose_fwpubliccurl.'css/oem/'.$this->customer_id.'/imgs/favicon.ico"> &nbsp;
                                    Schedule your scanning and update with WEBandWIRE PagePROTECT <sup>Now</sup></div>
                                </div></a>
                                </div>
                                <div class="col-sm-3">
    ...
    public function getCallToActionAndFooter()
    {
        ...
        return '<div class="row row-set footer-box" style="margin-top:14px;">
		   ...
		   <div class="row">
		      ...
		      <p class="pull-center">
		         WEBandWIRE PagePROTECT is a portfolio of WEBandWIRE Internet- und EDV-Dienstleistungen. &copy;  <?php echo date("Y"); ?> <a
					href="https://webandwire.de/" target="_blank">WEBandWIRE PagePROTECT</a>. All Rights Reserved. <br /> Credits
				to: <a href="http://www.centrora.com" target="_blank">Centrora Security!&#0174;</a>
		      </p>
		    </div>
		  </div>';
    ...
    public function showLoginHeader()
    {
        ...
        $html .= '<div class="header-wrapper">
                    WEBandWIRE PagePROTECT Member Login<small> You can login here with your WEBandWIRE PagePROTECT Account to activate your premium services</small>
                </div>';
        $html .= '</div>';
        echo $html;
    }
