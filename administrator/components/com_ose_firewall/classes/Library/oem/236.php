...
class CentroraOEM236 {
    ...
    public function getCallToActionAndFooter()
    {
        ...
        return '<div class="row row-set footer-box" style="margin-top:14px;">
                                <div class="col-sm-12 footer-innerbox" style="padding-left: 0px; padding-right: 20px;">
                                 <a href="http://gabemedia.dk/" target="_blank"><div class="call-to-action">
                                    ...
                                    Schedule your scanning and update with Gabemedia. <sup>Now</sup></div>
                                </div></a>
                                </div>
                                <div class="col-sm-3">
    ...
    public function showLoginHeader()
    {
        ...
        $html .= '<div class="header-wrapper">
                   Gabemedia Member Login<small> You can login here with your Gabemedia Account to activate your premium services</small>
                </div>';
        $html .= '</div>';
        echo $html;
    }
