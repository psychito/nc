...
class MfscanModel extends BaseModel
{
    ...
    public function getLastScan()
    {
        oseFirewall::callLibClass('vsscanner', 'mfscanner');
        $scanner = new mfScanner ();
        return $scanner->getLastMfScanFormattedResult();
    }
    public function exportcsv_mfscan()
    {
        oseFirewall::callLibClass('vsscanner', 'mfscanner');
        $scanner = new mfScanner();
        $contents = $scanner->getExportCSVInstructions();
        return $contents;
    }

    public function downloadScanResultsCSV($filename)
    {
        oseFirewall::callLibClass('vsscanner', 'mfscanner');
        $scanner = new mfScanner();
        $scanner->downloadMFScanResultCSV($filename);
