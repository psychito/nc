...
jQuery(document).ready(function($){
    ...
    //if (window.location.hash == '#adfirewall') {
    //    document.getElementById('scantabid').className = 'inactive';
    //    document.getElementById('adfirewalltabid').className = 'active';
    //    $('#tabs').tabs({
    //        active: 3
    //    });
    //}
...
function enableManualUpdate($) {
    $('#updateAdvRules').show();
    $("#updateAdvRules").one("click", function () {
        downloadRequest('ath');
    });
}
